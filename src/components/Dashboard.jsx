...
const Dashboard = () => {
    ...
    return (
        <>
            <nav
                className="fixed top-0 left-0 w-20 h-full space-y-8 bg-white border-r">
                    ...
                    <div className="flex flex-col flex-1 h-full">
                        <ul className="flex-1 px-4 text-sm font-medium">
                            {
                                navigation.map((item, idx) => (
                                    <li key={idx}>
                                        <a href={item.href} className="relative flex items-center justify-center p-2 text-gray-600 duration-150 rounded-lg gap-x-2 hover:bg-gray-50 active:bg-gray-100 group">
                        ...
                        <div>
                            ...
                            <div className="relative px-4 py-4 border-t">
                                <button ref={profileRef} className="flex items-center w-12 h-12 duration-150 rounded-full cursor-pointer gap-x-4 ring-offset-2 ring-gray-800 focus:ring-2"
                                ...
                                {
                                    isProfileActive ? (
                                        <div className="absolute w-64 text-sm text-gray-600 bg-white border rounded-lg shadow-md bottom-4 left-20">
                                            <div className="p-2">
                                                <span className="block p-2 text-gray-500/80">vienna@gmail.com</span>
                                                <a href="javascript:void(0)" className="block w-full p-2 text-left duration-150 rounded-md hover:bg-gray-50 active:bg-gray-100">
                                                    Status
                                                </a>
                                                <div className="relative duration-150 rounded-md hover:bg-gray-50 active:bg-gray-100">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="absolute inset-y-0 w-4 h-4 my-auto pointer-events-none right-1">
